...
- Usage: Reference from command with `@/Users/mscaltrini/Dev/masca88/pilactive-helper/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/mscaltrini/Dev/masca88/pilactive-helper/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/mscaltrini/Dev/masca88/pilactive-helper/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
