...
<!-- For checkpoint task examples and patterns, see @/Users/mscaltrini/Dev/masca88/pilactive-helper/.claude/get-shit-done/references/checkpoints.md -->
...
See `/Users/mscaltrini/Dev/masca88/pilactive-helper/.claude/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `/Users/mscaltrini/Dev/masca88/pilactive-helper/.claude/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `/Users/mscaltrini/Dev/masca88/pilactive-helper/.claude/get-shit-done/workflows/verify-phase.md` for verification logic.
