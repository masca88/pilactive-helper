...
- **Global scope**: `/Users/mscaltrini/Dev/masca88/pilactive-helper/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/mscaltrini/Dev/masca88/pilactive-helper/.claude/notes/`)
...
2. Glob `/Users/mscaltrini/Dev/masca88/pilactive-helper/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/mscaltrini/Dev/masca88/pilactive-helper/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/mscaltrini/Dev/masca88/pilactive-helper/.claude/notes/` — works in any directory
