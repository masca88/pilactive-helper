...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /Users/mscaltrini/Dev/masca88/pilactive-helper/.claude
                  → checks /Users/mscaltrini/Dev/masca88/pilactive-helper/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /Users/mscaltrini/Dev/masca88/pilactive-helper/.claude/get-shit-done
                  → writes to /Users/mscaltrini/Dev/masca88/pilactive-helper/.claude/get-shit-done/hooks/
...
@/Users/mscaltrini/Dev/masca88/pilactive-helper/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @/Users/mscaltrini/Dev/masca88/pilactive-helper/.claude/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "/Users/mscaltrini/Dev/masca88/pilactive-helper/.claude/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/Users/mscaltrini/Dev/masca88/pilactive-helper/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/Users/mscaltrini/Dev/masca88/pilactive-helper/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
